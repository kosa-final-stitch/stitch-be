 ...
 * @Author 박주희
 *
 * 2024.9.17. 박요한 | "/api/courses/**", "/api/reviews/top", "/api/home/**" permitAll 추가
 *  */
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(authorize -> authorize //각 url 패턴에 대해 접근 권한 설정
                        ...
                        .requestMatchers("/api/login", "/api/signup","/api/validate-email", "/api/validate-nickname", "/api/board/community/all", "/api/academies/**", "/api/courses/**", "/api/reviews/top", "/api/home/**").permitAll()
